...
export class APIService {
    ...
    OnCreateRestaurantListener: Observable<SubscriptionResponse<Pick<__SubscriptionContainer, 'onCreateRestaurant'>>> =
        API.graphql(
            graphqlOperation(
        ...
        ) as Observable<SubscriptionResponse<Pick<__SubscriptionContainer, 'onCreateRestaurant'>>>;

    OnUpdateRestaurantListener: Observable<SubscriptionResponse<Pick<__SubscriptionContainer, 'onUpdateRestaurant'>>> =
        API.graphql(
            graphqlOperation(
        ...
        ) as Observable<SubscriptionResponse<Pick<__SubscriptionContainer, 'onUpdateRestaurant'>>>;

    OnDeleteRestaurantListener: Observable<SubscriptionResponse<Pick<__SubscriptionContainer, 'onDeleteRestaurant'>>> =
        API.graphql(
            graphqlOperation(
        ...
        ) as Observable<SubscriptionResponse<Pick<__SubscriptionContainer, 'onDeleteRestaurant'>>>;
}
